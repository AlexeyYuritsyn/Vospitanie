...
const mapStateToProps = ({practicesReducer, globalReducer}) => ({
    mobileFilterDelete: practicesReducer.mobileFilterDelete,
    eventTypeFilters: practicesReducer.eventTypeFilters,
    forWhomFilters: practicesReducer.forWhomFilters,
